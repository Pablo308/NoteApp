...
class NoteAdapter: RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() { //confirms the contents of Notes
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NoteViewHolder {
        return NoteViewHolder(
            NoteLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false) //defining
        )
    }
